...
public :
	...
	virtual const std::string &	Sequence() const = 0;			//	return the sequence (as "cggatacgcggatagcatcg...") or the protein
...
protected:
	...
	const NFieldSubTypeEnum m_SubType; //	0 for DNA, 1 for protein
