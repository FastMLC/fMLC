...
//inline const char * ToString(char * dest, char x)							{	sprintf_s(dest, 256, "%c", x) ;			return(dest) ;				}
//inline const char * ToString(char * dest, wchar_t x)						{	sprintf_s(dest, 256, "%c", x) ;			return(dest) ;				}	//	%C and %c expect a Unicode char for swprintf
//inline const char * ToString(char * dest, unsigned char x)				{	sprintf_s(dest, 256, "%hc", x) ;			return(dest) ;				}
inline const char * ToString(char * dest, short x)							{	sprintf_s(dest, 256, "%hi", x) ;				return(dest) ;				}
inline const char * ToString(char * dest, unsigned short x)				{	sprintf_s(dest, 256, "%hu", x) ;				return(dest) ;				}
inline const char * ToString(char * dest, int32_t x)							{	sprintf_s(dest, 256, "%i", x) ;				return(dest) ;				}
inline const char * ToString(char * dest, uint32_t x)						{	sprintf_s(dest, 256, "%u", x) ;				return(dest) ;				}
inline const char * ToString(char * dest, int64_t x)						{	sprintf_s(dest, 256, "%I64d", x) ;			return(dest) ;				}
inline const char * ToString(char * dest, uint64_t x)						{	sprintf_s(dest, 256, "%I64u", x) ;			return(dest) ;				}
const char			* ToString(char * dest, double x, int32_t decimal = 3) ;

//	unicode versions
//inline const wchar_t * ToString(wchar_t * dest, char x)					{	swprintf_s(dest, 256, L"%c", x) ;		return(dest) ;				}
//inline const wchar_t * ToString(wchar_t * dest, wchar_t x)				{	swprintf_s(dest, 256, L"%c", x) ;		return(dest) ;				}	//	%C and %c expect a Unicode char for swprintf
//inline const wchar_t * ToString(wchar_t * dest, unsigned char x)		{	swprintf_s(dest, 256, L"%hc", x) ;		return(dest) ;				}
inline const char		* ToString02(char * dest, int32_t x)					{	sprintf_s(dest, 256, "%02i", x) ;			return(dest) ;				}
inline const wchar_t * ToString(wchar_t * dest, int16_t x)					{	swprintf_s(dest, 256, L"%hi", x) ;			return(dest) ;				}
inline const wchar_t * ToString(wchar_t * dest, uint16_t x)					{	swprintf_s(dest, 256, L"%hu", x) ;			return(dest) ;				}
inline const wchar_t * ToString(wchar_t * dest, int32_t x)					{	swprintf_s(dest, 256, L"%i", x) ;			return(dest) ;				}
inline const wchar_t * ToString(wchar_t * dest, uint32_t x)					{	swprintf_s(dest, 256, L"%u", x) ;			return(dest) ;				}
inline const wchar_t * ToString02(wchar_t * dest, int32_t x)				{	swprintf_s(dest, 256, L"%02i", x) ;			return(dest) ;				}
inline const wchar_t * ToString02(wchar_t * dest, uint32_t x)				{	swprintf_s(dest, 256, L"%02u", x) ;			return(dest) ;				}
inline const wchar_t * ToString03(wchar_t * dest, int32_t x)				{	swprintf_s(dest, 256, L"%03i", x) ;			return(dest) ;				}
...
inline const wchar_t * ToStringX(wchar_t * dest, uint32_t x)				{	swprintf_s(dest, 256, L"0x%06X", x) ;		return(dest) ;					}	//	for COLORREF
...
inline const wchar_t * ToStringX(wchar_t * dest, int32_t x)					{	swprintf_s(dest, 256, L"0x%X", static_cast<uint32_t>(x)) ;	return(dest) ;	}
//inline const wchar_t * ToStringX(wchar_t * dest, uint32_t x)				{	swprintf_s(dest, 256, L"0x%X", x) ;			return(dest) ;					}
//	From Rgb() to RRGGBB in hexadecimal
inline const wchar_t * ToStringRgb(wchar_t * dest, uint32_t x)				{	swprintf_s(dest, 256, L"%02X%02X%02X", x & 0xFF, (x >> 8) & 0xFF, (x >> 16) & 0xFF) ;	return(dest) ;	}
inline const wchar_t * ToStringP(wchar_t * dest, const void * x)			{	swprintf_s(dest, 256, L"0x%p", x) ;			return(dest) ;					}
//inline const wchar_t * ToString(wchar_t * dest, int32_t x)				{	swprintf_s(dest, 256, L"%li", x) ;			return(dest) ;					}
//inline const wchar_t * ToString(wchar_t * dest, uint32_t x)				{	swprintf_s(dest, 256, L"%lu", x) ;			return(dest) ;					}
inline const wchar_t * ToString(wchar_t * dest, int64_t x)					{	swprintf_s(dest, 256, L"%I64d", x) ;		return(dest) ;					}
inline const wchar_t * ToString(wchar_t * dest, uint64_t x)					{	swprintf_s(dest, 256, L"%I64u", x) ;		return(dest) ;					}
inline const wchar_t * ToString(wchar_t * dest, float x)						{	swprintf_s(dest, 256, L"%E", x) ;			return(dest) ;					}
