...
${OBJECTDIR}/src/MLC/Clustering/boost_plugin.o: src/MLC/Clustering/boost_plugin.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/boost_plugin.o src/MLC/Clustering/boost_plugin.cpp

${OBJECTDIR}/src/MLC/Clustering/ccbc_context.o: src/MLC/Clustering/ccbc_context.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/ccbc_context.o src/MLC/Clustering/ccbc_context.cpp

${OBJECTDIR}/src/MLC/Clustering/cluster.o: src/MLC/Clustering/cluster.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/cluster.o src/MLC/Clustering/cluster.cpp

${OBJECTDIR}/src/MLC/Clustering/cluster_context.o: src/MLC/Clustering/cluster_context.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/cluster_context.o src/MLC/Clustering/cluster_context.cpp

${OBJECTDIR}/src/MLC/Clustering/clusterdb.o: src/MLC/Clustering/clusterdb.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/clusterdb.o src/MLC/Clustering/clusterdb.cpp

${OBJECTDIR}/src/MLC/Clustering/clustering.o: src/MLC/Clustering/clustering.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/clustering.o src/MLC/Clustering/clustering.cpp

${OBJECTDIR}/src/MLC/Clustering/clusterproperties.o: src/MLC/Clustering/clusterproperties.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/clusterproperties.o src/MLC/Clustering/clusterproperties.cpp

${OBJECTDIR}/src/MLC/Clustering/comparison.o: src/MLC/Clustering/comparison.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/comparison.o src/MLC/Clustering/comparison.cpp

${OBJECTDIR}/src/MLC/Clustering/double_matrix.o: src/MLC/Clustering/double_matrix.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/double_matrix.o src/MLC/Clustering/double_matrix.cpp

${OBJECTDIR}/src/MLC/Clustering/double_vector.o: src/MLC/Clustering/double_vector.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/double_vector.o src/MLC/Clustering/double_vector.cpp

${OBJECTDIR}/src/MLC/Clustering/eigenval.o: src/MLC/Clustering/eigenval.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/eigenval.o src/MLC/Clustering/eigenval.cpp

${OBJECTDIR}/src/MLC/Clustering/log.o: src/MLC/Clustering/log.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/log.o src/MLC/Clustering/log.cpp

${OBJECTDIR}/src/MLC/Clustering/matrix_context.o: src/MLC/Clustering/matrix_context.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/matrix_context.o src/MLC/Clustering/matrix_context.cpp

${OBJECTDIR}/src/MLC/Clustering/mlc_context.o: src/MLC/Clustering/mlc_context.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/mlc_context.o src/MLC/Clustering/mlc_context.cpp

${OBJECTDIR}/src/MLC/Clustering/nfieldbase.o: src/MLC/Clustering/nfieldbase.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/nfieldbase.o src/MLC/Clustering/nfieldbase.cpp

${OBJECTDIR}/src/MLC/Clustering/std_plugin.o: src/MLC/Clustering/std_plugin.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/std_plugin.o src/MLC/Clustering/std_plugin.cpp

${OBJECTDIR}/src/MLC/Clustering/task.o: src/MLC/Clustering/task.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/task.o src/MLC/Clustering/task.cpp

${OBJECTDIR}/src/MLC/Clustering/taskmap.o: src/MLC/Clustering/taskmap.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/taskmap.o src/MLC/Clustering/taskmap.cpp

${OBJECTDIR}/src/MLC/Clustering/toolbox.o: src/MLC/Clustering/toolbox.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/toolbox.o src/MLC/Clustering/toolbox.cpp

${OBJECTDIR}/src/MLC/Clustering/tostring.o: src/MLC/Clustering/tostring.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/tostring.o src/MLC/Clustering/tostring.cpp

${OBJECTDIR}/src/MLC/Clustering/uclust_context.o: src/MLC/Clustering/uclust_context.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/uclust_context.o src/MLC/Clustering/uclust_context.cpp

${OBJECTDIR}/src/MLC/Clustering/wait.o: src/MLC/Clustering/wait.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/Clustering
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/Clustering/wait.o src/MLC/Clustering/wait.cpp
...
${OBJECTDIR}/src/MLC/MfcCluster/consoleappentrypoint.o: src/MLC/MfcCluster/consoleappentrypoint.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/MfcCluster/consoleappentrypoint.o src/MLC/MfcCluster/consoleappentrypoint.cpp

${OBJECTDIR}/src/MLC/MfcCluster/mfcclusterbusiness.o: src/MLC/MfcCluster/mfcclusterbusiness.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/MfcCluster
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/MfcCluster/mfcclusterbusiness.o src/MLC/MfcCluster/mfcclusterbusiness.cpp

${OBJECTDIR}/src/MLC/MfcCluster/optimizer.o: src/MLC/MfcCluster/optimizer.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/MfcCluster
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/MfcCluster/optimizer.o src/MLC/MfcCluster/optimizer.cpp

${OBJECTDIR}/src/MLC/MfcCluster/testfieldbase.o: src/MLC/MfcCluster/testfieldbase.cpp
	${MKDIR} -p ${OBJECTDIR}/src/MLC/MfcCluster
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MLC/MfcCluster/testfieldbase.o src/MLC/MfcCluster/testfieldbase.cpp
